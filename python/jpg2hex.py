...
image_path = os.path.join(script_dir, '../images/cat_image.jpg') 
hex_path = os.path.join(script_dir, '../data/input_image.hex')
resized_path = os.path.join(script_dir, '../images/original/resized_input_rgb.jpg')
